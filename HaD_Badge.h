...
volatile uint16_t RXserial  @ 0x15;     //RXserial(2 bytes) Received serial number(binary), ready for comparison
volatile uint16_t MySerial  @ 0x16;     //MySerial(2 bytes) unit serial number copied from ROM address 0x100E
volatile uint16_t Dummy     @ 0x18;     //This area was not specified
